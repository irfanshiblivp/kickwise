...
export interface Match {
  id: string;
  round: number; // 1: Group 1, 2: Group 2, 3: Group 3, 4: Round of 32/Knockouts
...
let users: User[] = [
  { id: 'admin-1', username: 'admin', password: 'admin', year: '4th', department: 'CSE', points: 0, isAdmin: true }
];
